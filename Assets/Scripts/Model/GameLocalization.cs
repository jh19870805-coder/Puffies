...
internal static class GameLocalizationCatalog
{
    ...
    public static GameLocalization.LocalizedEntry[] CreateEntries()
    {
        return new[]
        {
            ...
            E("task.all_packs_collected", "已获得全部卡包", "All puzzle packs collected", "Все наборы собраны", "Has conseguido todos los paquetes", "Conseguiste todos los paquetes", "Todos os pacotes foram obtidos", "Obtiveste todos os pacotes", "Alle Puzzle-Packs gesammelt", "모든 퍼즐 팩을 획득했습니다", "Tous les packs ont été obtenus", "すべてのパックを獲得しました", "Tüm bulmaca paketleri alındı", "已獲得全部拼圖包", "Zdobyto wszystkie paczki", "Hai ottenuto tutti i pacchetti", "Усі набори отримано", "Đã nhận tất cả gói xếp hình", "ได้รับแพ็กพัซเซิลครบแล้ว"),

    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_8847 = 0.0;
                float4 node_3510 = _Time;
                float node_82_ang = node_3510.g;
                ...
                float node_3884_ang = node_3510.g;
                ...
                float node_8866_ang = node_3510.g;
                ...
                float node_5237 = pow(lerp(0,1,(_NoiseMaskSwitch_var*(dot(_node_752.rgb,float3(0.3,0.59,0.11))*_node_752.a))),_NoiseExpAsSubTex);
...
////// Emissive:
                ...
                return fixed4(finalColor,node_9640);
            }
            ENDCG
        }
    }
